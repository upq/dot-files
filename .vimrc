...
" For errors displayed mostly when working with angular 
" HTML tags, data attributes ..etc
...
" colorscheme atom
" colorscheme up  " fix the cursor line
...
" Enable display whitespace characters (Default)
set list

" Limit syntax highlight for the first 250 column
" Try loading a minified js file and you will know why!
set synmaxcol=250
...
"--------------------------------------------------
" Custom maps to vim defaults.

" Change the gt and gT (moving between tabs).
map <C-i> :tabn<CR>
map <C-o> :tabp<CR>
map <C-n> :tabnew<CR>

" Map K to unjoin lines.
nnoremap K i<CR><Esc>

" Set the cursor in the right place after braces.
" (To fix indentation after if statements).
...
" Moves a line in all modes
" cool when used in v-block :D
" For alt key
" http://stackoverflow.com/questions/7501092/can-i-map-alt-key-in-vim
" but Im more of a control guy
...
" Allows to go to the SASS definition from html when
" pressing f9
function! JumpToSASSDefinition()
